...
| File | Description |
|------|-------------|
| `main.tf` | Full 3-tier setup: VPC, subnets, ALB, ASG, RDS, security groups |
| `user_data.sh` | Bootstrap script for EC2 instances (Apache + PHP app) |
